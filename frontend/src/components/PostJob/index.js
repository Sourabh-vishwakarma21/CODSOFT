...
//   return (
//     <form onSubmit={handleSubmit} style={{ padding: 24, maxWidth: 640, margin: "20px auto", display: "flex", flexDirection: "column", gap: 12 ,color:"white"}}>
//       <h2>Post a Job</h2>
...
//       <button type="submit" style={{ width: 100, padding: 10, background:"skyblue",boder:"none" }}>Submit</button>
//     </form>
//   );
// }
